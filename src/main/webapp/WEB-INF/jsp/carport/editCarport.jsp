...
<form id="editForm" class="form-horizontal" action="${pageContext.request.contextPath }/editCarportSubmit.do" method="post">
	<input type="hidden" name="carportId" value="${item.carportId }"/>
	<div class="container">
		<div class="panel panel-success">
			<div class="panel-heading">
				<h3 class="panel-title">更新车位信息</h3>
			</div>
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-6" id="date1">
						<input type="text" class="form-control" name="carportUsedate" value="${item.carportUsedate }" placeholder="启用时间">
					</div>
					<span class="col-sm-4"></span>
				</div>
				<div class="form-group">
