...
<form id="editForm" class="form-horizontal" action="${pageContext.request.contextPath }/editComplainSubmit.do" method="post">
	<input type="hidden" name="complainId" value="${item.complainId }"/>
	<div class="container">
		<div class="panel panel-success">
			<div class="panel-heading">
				<h3 class="panel-title">更新投诉信息</h3>
			</div>
