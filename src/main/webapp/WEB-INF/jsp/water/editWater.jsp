...
<form id="editForm" class="form-horizontal" action="${pageContext.request.contextPath }/editWaterSubmit.do" method="post">
	<input type="hidden" name="waterId" value="${item.waterId }"/>
	<div class="container">
		<div class="panel panel-success">
			<div class="panel-heading">
				<h3 class="panel-title">更新水费单</h3>
			</div>
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="text" class="form-control" name="waterStopdate" value="${item.waterStopdate }" placeholder="结束时间">
					</div>
					<span class="col-sm-4"></span>
				</div>
				<div class="form-group">
