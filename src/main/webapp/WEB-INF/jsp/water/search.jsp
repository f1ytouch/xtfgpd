				...
				<table class="table table-striped table-bordered table-hover table-condensed">
					...
					<tbody>
						<tr>
							...
							<td><a href="${pageContext.request.contextPath }/editWater.do?id=${item.waterId}">修改</a></td>
							<td><a href="${pageContext.request.contextPath }/deleteWater.do?id=${item.waterId}">删除</a></td>
