...
<nav class="navbar navbar-default" role="navigation">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-1 ">
				<a href="${pageContext.request.contextPath }/addRepairs.do" class="btn btn-primary btn-sm">添加</a>
			</div>
		</div>
				...
				<table class="table table-striped table-bordered table-hover table-condensed">
					...
					<c:forEach items="${repairs }" var="item">
						<tr>
							...
							<td><a class="btn btn-success btn-sm glyphicon glyphicon-pencil" href="${pageContext.request.contextPath }/editRepairs.do?id=${item.repairsId}">修改</a></td>
							<td><a class="btn btn-danger btn-sm glyphicon glyphicon-trash" href="${pageContext.request.contextPath }/deleteRepairs.do?id=${item.repairsId}">删除</a></td>
		...
		<div class="row">
			...
			<div class="col-sm-6">
				...
				<ul class="pagination">
					<li><a href="${pageContext.request.contextPath }/listRepairs.do?pageNow=1">首页</a></li>
					<c:choose>
						<c:when test="${page.pageNow - 1 > 0}">
							<li><a href="${pageContext.request.contextPath }/listRepairs.do?pageNow=${page.pageNow - 1}">上一页</a></li>
						</c:when>
						<c:when test="${page.pageNow - 1 <= 0}">
							<li><a href="${pageContext.request.contextPath }/listRepairs.do?pageNow=1">上一页</a></li>
						</c:when>
					</c:choose>
					<c:choose>
						<c:when test="${page.totalPageCount==0}">
							<li><a href="${pageContext.request.contextPath }/listRepairs.do?pageNow=${page.pageNow}">下一页</a></li>
						</c:when>
						<c:when test="${page.pageNow + 1 < page.totalPageCount}">
							<li><a href="${pageContext.request.contextPath }/listRepairs.do?pageNow=${page.pageNow + 1}">下一页</a></li>
						</c:when>
						<c:when test="${page.pageNow + 1 >= page.totalPageCount}">
							<li><a href="${pageContext.request.contextPath }/listRepairs.do?pageNow=${page.totalPageCount}">下一页</a></li>
						</c:when>
					</c:choose>

					<c:choose>
						<c:when test="${page.totalPageCount==0}">
							<li><a href="${pageContext.request.contextPath }/listRepairs.do?pageNow=${page.pageNow}">尾页</a></li>
						</c:when>
						<c:otherwise>
							<li><a href="${pageContext.request.contextPath }/listRepairs.do?pageNow=${page.totalPageCount}">尾页</a></li>
						</c:otherwise>
					</c:choose>
				</ul>
