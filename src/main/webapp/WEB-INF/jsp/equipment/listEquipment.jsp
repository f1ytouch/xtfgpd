	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-6">
				...
				<ul class="pagination">
					<li><a href="${pageContext.request.contextPath }/listEquipment.do?pageNow=1">首页</a></li>
					<c:choose>
						<c:when test="${page.pageNow - 1 > 0}">
							<li><a href="${pageContext.request.contextPath }/listEquipment.do?pageNow=${page.pageNow - 1}">上一页</a></li>
						</c:when>
						<c:when test="${page.pageNow - 1 <= 0}">
							<li><a href="${pageContext.request.contextPath }/listEquipment.do?pageNow=1">上一页</a></li>
						</c:when>
					</c:choose>
					<c:choose>
						<c:when test="${page.totalPageCount==0}">
							<li><a href="${pageContext.request.contextPath }/listEquipment.do?pageNow=${page.pageNow}">下一页</a></li>
						</c:when>
						<c:when test="${page.pageNow + 1 < page.totalPageCount}">
							<li><a href="${pageContext.request.contextPath }/listEquipment.do?pageNow=${page.pageNow + 1}">下一页</a></li>
						</c:when>
						<c:when test="${page.pageNow + 1 >= page.totalPageCount}">
							<li><a href="${pageContext.request.contextPath }/listEquipment.do?pageNow=${page.totalPageCount}">下一页</a></li>
						</c:when>
					</c:choose>

					<c:choose>
						<c:when test="${page.totalPageCount==0}">
							<li><a href="${pageContext.request.contextPath }/listEquipment.do?pageNow=${page.pageNow}">尾页</a></li>
						</c:when>
						<c:otherwise>
							<li><a href="${pageContext.request.contextPath }/listEquipment.do?pageNow=${page.totalPageCount}">尾页</a></li>
						</c:otherwise>
					</c:choose>
				</ul>
