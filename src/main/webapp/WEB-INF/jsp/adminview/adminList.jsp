				...
				<table class="table table-striped table-bordered table-hover table-condensed">
					...
					<c:forEach items="${adL }" var="item">
						<tr>
							...
							<td><a class="btn btn-success btn-sm glyphicon glyphicon-pencil" href="${pageContext.request.contextPath }/editAdmin.do?id=${item.id}">修改</a></td>
							<td><a class="btn btn-danger btn-sm glyphicon glyphicon-trash" href="${pageContext.request.contextPath }/deleteAdmin.do?id=${item.id}">删除</a></td>
